...
python -m torch.distributed.launch --nproc_per_node=4 multitask_finetuning.py \
    ...
    --logging_steps 50 \
    --seed 42 \
    --save_path "./models/mt5-large_multi_ft_19_vi" \
    --model_name_or_path "google/mt5-large" \
    --mt_train_filepath "./data/multitask_ft/translation_train_en-vi.json" \
    ...
    --mt_val_filepath "./data/multitask_ft/translation_val_en-vi.json" \
...
python -m torch.distributed.launch --nproc_per_node=4 text2sql.py \
    ...
    --epochs 50 \
    --seed 42 \
    --save_path "./models/mt5-large-19-text2sql_vi" \
    --model_name_or_path "./models/mt5-large_multi_ft_19_vi/best_model" \
    --mode train \
