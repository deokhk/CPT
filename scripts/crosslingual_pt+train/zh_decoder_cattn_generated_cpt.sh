...
PRET_MODEL_SAVE_PATH=./models/mt5-large-zh-cross-pt-decoder-cattn-gen
GENERATED_DATA_PATH=/home1/deokhk_1/research/XLang-NL2SQL/output/la_dec_cattn_only_mean_eng-mt5-sql2text-no-schema-50.16.3e-5.500/best_checkpoint/with_lang_generated_predictions_zh_beam_4_from_train_spider_seq2seq_english.json
...
PRET_BEST_MODEL_PATH=./models/mt5-large-zh-cross-pt-decoder-cattn-gen/best_model/
FT_MODEL_SAVE_PATH=./models/mt5-large-zh-cross-pt-decoder-cattn-gen-text2sql
